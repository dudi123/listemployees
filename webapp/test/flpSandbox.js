		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zlistemployees",
									"targetURL": "#zlistemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zlistemployees-display": {
								"semanticObject": "zlistemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zlistemployees",
									"url": sap.ui.require.toUrl("zlistemployees")
								}
							}
						}
					}
